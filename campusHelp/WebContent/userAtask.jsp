						...
						<fieldset class="layui-elem-field">
							...
							<c:forEach items="${list }" var="task">
								...
								<c:if test="${task.isEvaluation==1 }">
									<button class="layui-btn layui-btn-sm layui-btn-disabled layui-btn-radius">发布者已评价</button>
