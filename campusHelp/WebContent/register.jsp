					...
					<fieldset class="layui-elem-field">
						...
						<div class="layui-field-box">
							<form id="reform" class="layui-form layui-form-pane"
								...
								<div class="layui-form-item">
									<input type="button" id="phoneid" class="layui-btn" onclick="getPhoneVerificationCode()"  name="phone" value="获取验证码" />
									<div class="layui-input-inline">
										<input type="text" name="phone" placeholder="请输入手机号" id="phoneNumber" class="layui-input">
									</div>
								</div>
								<div class="layui-form-item">
