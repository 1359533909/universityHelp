				...
				<div class="layui-row">
					...
					<div class="layui-col-md10">
						<fieldset class="layui-elem-field">
							<legend>填写提现信息</legend>
							<form id="reform" class="layui-form layui-form-pane"
								  lay-filter="formFilter" action="withdraw/setWithdraw.do" method="post"
								  style="padding: 30px;">


								<div class="layui-form-item">
									<label class="layui-form-label">提现数额</label>
									<div class="layui-input-block">
										<select id="reward" name="amount"
												lay-filter="reward">
								...
								<c:if test="${nowuser.state==0 }">
									<div class="layui-form-item">
										<button class="layui-btn" lay-submit="reform"
												lay-filter="reform">申请</button>
									</div>
								</c:if>
								<c:if test="${nowuser.state!=0 }">
									<div class="layui-form-item">
										<button class="layui-btn layui-btn-disabled"
												lay-submit="reform" lay-filter="reform">状态被限制，无法申请</button>
									</div>
								</c:if>
